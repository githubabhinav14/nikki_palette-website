        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="tel:+917673926708" className="flex items-center gap-2 text-cream-300 hover:text-gold-400 transition-colors text-sm">
                <Phone size={16} />
                +91 76739 26708
              </a>
        ...
        <div className="border-t border-cream-700 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://wa.me/917673926708" target="_blank" rel="noopener noreferrer" className="text-cream-400 hover:text-gold-400 transition-colors">
